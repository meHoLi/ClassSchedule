// pages/defaultSetting/defaultSetting.js
const app = getApp()

let list = [
  { ID: 0, StartTime: '08:00', EndTime: '08:20', Name: 1, CourseIndex: 1, timeType: '上午' },
  ...
  { ID: 0, StartTime: '12:01', EndTime: '12:20', Name: 9, CourseIndex: 9, timeType: '下午' },
  ...
  { ID: 0, StartTime: '19:00', EndTime: '19:30', Name: 17, CourseIndex: 17, timeType: '晚上' },
...
Page({
  ...
  onLoad: function (options) {
    ...
    this.tempData(options.childrenID)
  },

  tempData: function (childrenID){
    let that = this;
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        wx.request({
          url: app.globalData.url + '/DefaultCourseTimeSetting/Index', //仅为示例，并非真实的接口地址
          data: {
            childrenID: childrenID
          },
          header: {
  ...
  //设置上午课次次数焦点离开
  setMorningNumInputBlur: function(e){debugger
  ...
  //添加上午时间行
  addOrDelMorningTime: function (defaultTimeList, isAddOrDel){debugger
  ...
  cancel: function(){
    wx.navigateBack({
      // url: "../addClass/addClass?childrenID=" + data.childrenID 
      delta: 1
    })
  },
  ...
  save: function(){
    ...
    defaultTimeList = defaultTimeList.map(o=>{
      if (!o.ChildrenID){
        o.ChildrenID = that.data.childrenID
      }
